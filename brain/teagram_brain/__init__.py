"""teagram voice brain — the Pipecat pipeline, packaged for install.
...
``teagram_brain.`` namespace.

The package is the import closure of the appliance entry point, ``gateway_server``
(``teagram-brain`` console script). Kept import-light: the pipeline's heavy deps
